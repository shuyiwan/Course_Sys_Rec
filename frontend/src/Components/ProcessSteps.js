                ...
                <div className="cs-right-section">
                    <div className="cs-item">
                        ...
                        <p className="cs-title"> <strong>Get Started</strong></p>
                            ...
                            Type keywords of courses, careers, or professors in search bar.
                        </p>
                    </div>
                    <div className="cs-item">
                        ...
                        <p className="cs-item-text">
                            Get relevant courses across all departments with a single search.
                        </p>
                    </div>
                    <div className="cs-item">
                        ...
                        <p className="cs-item-text">
                            Add courses to your personalized cart.
                        </p>
                    </div>
                    <div className="cs-item">
